...
void main() async {
    ...
    // Directory document = Directory(), //await getApplicationDocumentsDirectory();
    Hive.init("./hiveDB/");
    ...
    if (Hive.isBoxOpen("eventInfo") && Hive.isBoxOpen("dayRecords")){
        runApp(
            MultiProvider(
                providers: [
                    ChangeNotifierProvider(create: (context) => UserProfileLoader(dayRecordBox, eventInfoBox)),
...
//                 const InputDecorationTheme(border: OutlineInputBorder()),
//             ),
//             home: const MainPage(title: 'Time Block'),
//         );
//     }
// }
